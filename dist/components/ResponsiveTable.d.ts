...
export default function ResponsiveTable<E extends {}, C>({ className, columns, data, renderHead, renderBody, columnKeyExtractor, dataKeyExtractor, onColumnClick, style, rowHeight, htmlTooltip, loading, renderRow: RenderRow, renderCell, emptyNode, }: Props<E, C>): JSX.Element;
