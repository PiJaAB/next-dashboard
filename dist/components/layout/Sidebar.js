...
function DevelopmentLabel() {
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "w-14 inline-block bg-primary-600  dark:bg-primary-600 py-1 px-2 mb-4 rounded-r-3xl" }, { children: (0, jsx_runtime_1.jsx)("p", __assign({ className: "font-bold uppercase tracking-wide text-primary-100 whitespace-nowrap" }, { children: "DEV" })) })));
}
