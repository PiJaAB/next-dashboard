...
function UserInfo(_a) {
    ...
    if (compact) {
        return (react_2.default.createElement("div", { className: "w-10 h-10 bg-gray-300 rounded-full flex-shrink-0 overflow-hidden relative", "data-tip": title, "data-place": "right" },
            react_2.default.createElement(solid_1.UserIcon, { className: "h-full w-auto text-gray-500" }),
            pictureUrl != null && (react_2.default.createElement("div", { className: "absolute inset-0 bg-cover bg-no-repeat", style: { backgroundImage: "url('" + pictureUrl + "')" } }))));
    }
    return (react_2.default.createElement(react_2.default.Fragment, null,
        react_2.default.createElement("span", { className: "flex flex-1 min-w-0 items-center justify-center space-x-3" },
            react_2.default.createElement("div", { className: "w-10 h-10 bg-gray-300 rounded-full flex-shrink-0 overflow-hidden relative" },
                react_2.default.createElement(solid_1.UserIcon, { className: "h-full w-auto text-gray-500" }),
                pictureUrl != null && (react_2.default.createElement("div", { className: "absolute inset-0 bg-cover bg-no-repeat", style: { backgroundImage: "url('" + pictureUrl + "')" } }))),
        ...
        showSelector && (react_2.default.createElement(solid_1.SelectorIcon, { className: "flex-shrink-0 h-5 w-5 text-gray-400 group-hover:text-gray-500", "aria-hidden": "true" }))));
}
function UserAccountArea(_a) {
    ...
    if (groupedUserMenu.length === 0) {
        return (react_2.default.createElement("div", { className: "px-3 mt-6 relative inline-block text-left" },
            react_2.default.createElement("div", { className: "group w-full rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700" },
    ...
    return (react_2.default.createElement(react_1.Menu, { as: "div", className: "px-3 mt-6 relative inline-block text-left" },
        react_2.default.createElement(react_1.Menu.Button, { className: "group w-full rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-purple-500 dark:focus:ring-offset-gray-900 dark:focus:ring-purple-500" },
            react_2.default.createElement("span", { className: "flex w-full justify-between items-center" },
        ...
        react_2.default.createElement(UserMenu_1.default, { className: (0, classnames_1.default)(compact && 'left-0 w-48', !compact && 'right-0 left-0'), userTitle: compact ? userTitle : undefined, userSubTitle: compact ? userSubTitle : undefined, groupedUserMenu: groupedUserMenu })));
}
...
function Brand(_a) {
    ...
    if (squareLogoUrl != null) {
        return (react_2.default.createElement(link_1.default, { href: branding.homepageURL || '/' },
            react_2.default.createElement("a", { className: "flex items-center flex-shrink-0 px-6" },
                react_2.default.createElement("img", { className: "h-8 w-auto mr-2", src: squareLogoUrl, alt: branding.name }),
                title)));
    }
    return (react_2.default.createElement(link_1.default, { href: branding.homepageURL || '/' },
...
function Sidebar(_a) {
    ...
    return (react_2.default.createElement(react_2.default.Fragment, null,
        SidebarComp != null && (react_2.default.createElement(react_1.Transition.Root, { show: sidebarOpen, as: react_2.Fragment },
            react_2.default.createElement(react_1.Dialog, { as: "div", className: "fixed inset-0 flex z-40 lg:hidden", onClose: setSidebarOpen },
                ...
                react_2.default.createElement(react_1.Transition.Child, { as: react_2.Fragment, enter: "transition ease-in-out duration-300 transform", enterFrom: "-translate-x-full", enterTo: "translate-x-0", leave: "transition ease-in-out duration-300 transform", leaveFrom: "translate-x-0", leaveTo: "-translate-x-full" },
                    react_2.default.createElement("div", { className: "relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-100 dark:bg-gray-700" },
                        react_2.default.createElement(react_1.Transition.Child, { as: react_2.Fragment, enter: "ease-in-out duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "ease-in-out duration-300", leaveFrom: "opacity-100", leaveTo: "opacity-0" },
                            react_2.default.createElement("div", { className: "absolute top-0 right-0 -mr-12 pt-2" },
                                react_2.default.createElement("button", { type: "button", className: "ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white", onClick: function () { return setSidebarOpen(false); } },
                                    react_2.default.createElement("span", { className: "sr-only" }, s('close-sidebar')),
                                    react_2.default.createElement(outline_1.XIcon, { className: "h-6 w-6 text-white", "aria-hidden": "true" })))),
                        react_2.default.createElement(Brand, { compact: false }),
                        react_2.default.createElement("div", { className: "mt-5 flex-1 h-0 overflow-y-auto" },
                            react_2.default.createElement("nav", { className: "px-2" },
        ...
        react_2.default.createElement(NavEntry_1.IsCompactProvider, { value: isCompact },
            react_2.default.createElement("div", { className: "hidden lg:flex lg:flex-shrink-0" },
                react_2.default.createElement("div", { className: (0, classnames_1.default)('flex flex-col border-r border-gray-200 dark:border-gray-700 pt-5 pb-4 bg-gray-100 dark:bg-gray-700', !isCompact && 'w-64', isCompact && 'w-24') },
                    ...
                    react_2.default.createElement("div", { className: "h-0 flex-1 flex flex-col" },
                        ...
                        showSearch && (react_2.default.createElement("div", { className: "px-3 mt-5" },
                            ...
                            react_2.default.createElement("div", { className: "mt-1 relative rounded-md shadow-sm" },
                                react_2.default.createElement("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", "aria-hidden": "true" },
                                    react_2.default.createElement(solid_1.SearchIcon, { className: "mr-3 h-4 w-4 text-gray-400", "aria-hidden": "true" })),
                                react_2.default.createElement("input", { type: "text", name: "search", id: "search", className: "block w-full pl-9", placeholder: s('search'), value: searchText, onChange: handleSearchChange, onKeyDown: handleSearchDown })))),
                        react_2.default.createElement("div", { className: "px-3 mt-6 divide-y divide-gray-300 dark:divide-gray-500" },
                            ...
                            react_2.default.createElement(NavSection_1.default, { className: "py-2" },
                                ...
                                react_2.default.createElement(NavEntry_1.default, { Icon: isCompact ? outline_1.ArrowSmRightIcon : outline_1.ArrowSmLeftIcon, onClick: function () { return setState('compactSidebar', !isCompact); } }, s(isCompact ? 'sidebar-expand' : 'sidebar-compact'))))))))));
}
