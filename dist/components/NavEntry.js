...
function Inner(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [Icon != null && ((0, jsx_runtime_1.jsx)(Icon, { className: (0, classnames_1.default)(active
                    ? 'text-onPrimary-400'
                    : 'text-gray-600 dark:text-gray-300 group-hover:text-onPrimary-100 dark:group-hover:text-onPrimary-900', !isCompact && 'me-3', 'flex-shrink-0 h-6 w-6'), "aria-hidden": "true" })), (0, jsx_runtime_1.jsx)("span", __assign({ className: (0, classnames_1.default)(isCompact && 'sr-only', !isCompact &&
                    'overflow-hidden overflow-ellipsis flex-grow flex-shrink text-start') }, { children: children }))] }));
}
...
var ButtonEl = react_1.default.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", __assign({ ref: ref, type: "button", onClick: onClick, className: (0, classnames_1.default)(active
            ? 'bg-primary-400 text-onPrimary-400 hover:text-onPrimary-400 dark:text-onPrimary-400 dark:hover:text-onPrimary-400'
            : 'text-gray-600 dark:text-gray-300 hover:text-onPrimary-100 dark:hover:text-onPrimary-900 hover:bg-primary-100 dark:hover:bg-primary-900', isCompact && 'justify-center', 'w-full group flex items-center px-2 py-2 text-sm font-medium rounded-md'), "data-tip": isCompact ? children : undefined, "data-place": "right", "aria-current": active }, { children: (0, jsx_runtime_1.jsx)(Inner, __assign({ Icon: Icon, active: active, isCompact: isCompact }, { children: children })) })));
});
...
function NavEntry(_a) {
    ...
    if (href) {
        child = ((0, jsx_runtime_1.jsx)(LinkEl, __assign({ active: active, href: href, Icon: IconToRender, as: as, onClick: onClick, ref: tipRef, isCompact: isCompact }, { children: children })));
    }
    else {
        child = ((0, jsx_runtime_1.jsx)(ButtonEl, __assign({ active: active, Icon: IconToRender, as: as, onClick: onClick, ref: tipRef, isCompact: isCompact }, { children: children })));
    }
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, classnames_1.default)(open &&
            submenu != null &&
            'bg-black bg-opacity-10 dark:bg-opacity-25 rounded-md') }, { children: [child, open && submenu != null && (0, jsx_runtime_1.jsx)(ClonedEl, { el: submenu })] })));
}
