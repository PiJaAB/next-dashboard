...
function NavEntry(_a) {
    var _b, _c, _d;
    var href = _a.href, rawChildren = _a.children, Icon = _a.Icon, as = _a.as, propActive = _a.active, onClick = _a.onClick, tipRef = _a.tipRef;
    ...
    var child;
    if (href) {
        child = (react_1.default.createElement(LinkEl, { active: active, href: href, Icon: Icon, as: as, onClick: onClick, ref: tipRef, isCompact: isCompact }, children));
    }
    else {
        child = (react_1.default.createElement(ButtonEl, { active: active, Icon: Icon, as: as, onClick: onClick, ref: tipRef, isCompact: isCompact }, children));
    }
