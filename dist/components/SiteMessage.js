    ...
    return (react_1.default.createElement("div", { className: (0, classnames_1.default)('p-2 rounded-lg shadow-lg sm:p-3', status === 'info' && 'bg-indigo-600', status === 'error' && 'bg-red-600', status === 'warning' && 'bg-yellow-600') },
        react_1.default.createElement("div", { className: "flex items-center justify-between flex-wrap" },
            react_1.default.createElement("div", { className: "flex-1 flex items-center" },
                ...
                react_1.default.createElement("p", { className: "ms-3 font-medium text-white" },
                    title || s(status),
                    ": ",
                    message)),
            ...
            dismiss && (react_1.default.createElement("div", { className: "order-2 flex-shrink-0 sm:order-3 sm:ms-2" },
                react_1.default.createElement("button", { type: "button", className: (0, classnames_1.default)('-me-1 flex p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-white', status === 'info' && 'hover:bg-indigo-500', status === 'error' && 'hover:bg-red-500', status === 'warning' && 'hover:bg-yellow-500'), onClick: dismiss },
