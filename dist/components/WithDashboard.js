...
function WithDashboard(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(useS_1.StringsProvider, __assign({ value: computedStrings }, { children: (0, jsx_runtime_1.jsx)(configContext_1.default.Provider, __assign({ value: configCtx }, { children: (0, jsx_runtime_1.jsx)(dashboardContext_1.DashboardProvider, { children: children }) })) })));
}
