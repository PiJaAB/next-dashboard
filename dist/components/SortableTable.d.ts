...
declare type Compare<E> = (a: E, b: E, prop: string | number | symbol, dir: 'asc' | 'desc') => number;
declare type CompareBy<E> = (entry: E, prop: string | number | symbol, dir: 'asc' | 'desc') => string | number | null | undefined;
