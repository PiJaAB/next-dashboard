...
function DashboardProvider(_a) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        statusReporter_1.statusEventEmitter.on('report', onReport);
        statusReporter_1.statusEventEmitter.on('error', onError);
        return function () {
            statusReporter_1.statusEventEmitter.off('report', onReport);
            statusReporter_1.statusEventEmitter.off('error', onError);
        };
    }, [registerSiteMessage]);
    ...
    return ((0, jsx_runtime_1.jsx)(DashboardContext.Provider, __assign({ value: ctx }, { children: (0, jsx_runtime_1.jsx)(layoutContext_1.LayoutStateProvider, { children: children }) })));
}
